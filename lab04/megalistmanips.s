...
mapLoop:
    lw t1, 0(s0)        # Bug #5 # load the address of the array of current node into t1
    ...
    lw a0, 8(s0)        #Bug 2, # load the address of the next node into a0
    mv a1, s1           #Bug 3, # put the address of the function back into a1 to prepare for the recursion
